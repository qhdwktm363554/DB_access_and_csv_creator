...
"font: italic 10pt \"72\";")
    ...
    def retranslateUi(self, Bong_1st_win):
        ...
        Bong_1st_win.setWindowTitle(_translate("Bong_1st_win", "Line selection [AOI]"))
...
"font: 맑은 고딕 13pt \"75\";")
    ...
    def submit(self):
        ...
        for i in df['MLFB'].index:
            ...
            # df2 = df2[['SMD#', 'Part#', 'Ref#', 'x', 'y', 'Angle_degree']]        #이건 BOM 비교용
            df2 = df2[['Ref#', 'Part#', 'x', 'y', 'Angle_degree', 'omit']]                  # 이건 AOI 용
            omitted = df2.loc[df2['omit'] == True, 'omit'].index                            # 이것도 AOI 용
            df2.drop(omitted, inplace=True)     
            df2 = df2[['Ref#', 'Part#', 'x', 'y', 'Angle_degree']]                                            # 이것도 AOI 용
    ...
    def retranslateUi(self, Bong_2nd_win):
        _translate = QtCore.QCoreApplication.translate
        Bong_2nd_win.setWindowTitle(_translate("Bong_2nd_win", "Final directory input [AOI]"))
